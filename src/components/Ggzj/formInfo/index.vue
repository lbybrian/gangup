            ...
            >
              <slot>
                ...
                <span v-else-if="d.type === 'button'||item.type==='button'" v-for="btn in d.value">
                	<el-button   v-if="btn.type==='button1'" @click="submitForm('dataInfo')" style="margin-right: 45px;">
						{{btn.name}}
					</el-button>
					<el-button  v-if="btn.type==='button2'" @click="resetForm(item)" >
