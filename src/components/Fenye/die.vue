	...
	<div>
		<div class="page-helper" v-if="showPageHelper">
			<div class="page-list">
				...
				<span class="page-item" v-for="num in groupList" :class="{'page-current':currentPage===num}" :key="num" @click="jumpPage(num)">{{num}}</span>
...
<!--父组件中：<page-helper @jumpPage="jumpPage" :page-number="pageNumber" page-size-array="PageSizeArray"></page-helper>-->
<script>
	export default{
		name: 'pageHelper',
		data() {
