	...
	export default{
		...
		computed:{
			colors(age){
				return(age)=>{
					switch(age){
						case age<18:return{ 'color':'red' };
						case 18<=age<58:return{ 'color':'greey' };
						case 58<=age:return{ 'color':'yellow' };
						break;
					}
				}
			}
		...
		methods:{
	      ...
	      getDay(){
			...
			switch (d) 
			{ 
			  case 0:this.d="今天是星期日"; 
			  break; 
			  case 1:this.d="今天是星期一"; 
			  break; 
			  case 2:this.d="今天是星期二"; 
			  break; 
			  case 3:this.d="今天是星期三"; 
			  break; 
			  case 4:this.d="今天是星期四"; 
			  break; 
			  case 5:this.d="今天是星期五"; 
			  break; 
			  case 6:this.d="今天是星期六"; 
			  break; 
			}
	      }
