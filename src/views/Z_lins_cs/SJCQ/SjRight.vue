			...
			<div class="dataBox" v-for="item in typeList">
				<el-row class="tagBox">
					...
					<el-col :span="21">
						...
						<el-button v-if="isEdit && item.id=='kt'" class="button-new-tag" size="small" @click="showInput(ktInputVisible,'kt')">{{ktInputVisible?"确定":"+客体"}}</el-button>
						<el-button v-if="isEdit && item.id=='sj'" class="button-new-tag" size="small" @click="showInput(sjInputVisible,'sj')">{{sjInputVisible?"确定":"+时间"}}</el-button>
						<el-button v-if="isEdit && item.id=='dz'" class="button-new-tag" size="small" @click="showInput(dzInputVisible,'dz')">{{dzInputVisible?"确定":"+地址"}}</el-button>
					</el-col>
				</el-row>
